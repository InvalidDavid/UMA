package org.koitharu.kotatsu.parsers.site.tachiyomi.es.mangaoni
...
@TachiyomiSource("MANGAONI", "MangaOni", "es")
class MangaOni :
    HttpSource(),
    ConfigurableSource {
    ...
    override fun setupPreferenceScreen(screen: androidx.preference.PreferenceScreen) {
        val contentPref = android.preference.CheckBoxPreference(screen.context).apply {
            key = CONTENT_PREF
