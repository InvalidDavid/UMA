package org.koitharu.kotatsu.parsers.site.kotatsu.wpcomics.vi
...
import org.koitharu.kotatsu.parsers.site.kotatsu.wpcomics.WpComicsParser
...
internal class NetTruyenVie(context: MangaLoaderContext) :
	WpComicsParser(context, MangaParserSource.NETTRUYENVIE, "nettruyenviet10.com", 36) {
