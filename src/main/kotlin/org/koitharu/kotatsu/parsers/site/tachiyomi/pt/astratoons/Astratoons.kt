package org.koitharu.kotatsu.parsers.site.tachiyomi.pt.astratoons
...
@TachiyomiSource("ASTRATOONS", "Astratoons", "pt")
class Astratoons : HttpSource() {
    ...
    override fun popularMangaRequest(page: Int): Request {
        ...
        val url = "$baseUrl/api/comics"
            .toHttpUrl()
            .newBuilder()
            .addQueryParameter("sortBy", "views")
            .addQueryParameter("page", page.toString())
            .addQueryParameter("perPage", "40")
            .build()
