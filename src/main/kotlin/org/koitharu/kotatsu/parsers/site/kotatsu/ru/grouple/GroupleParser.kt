package org.koitharu.kotatsu.parsers.site.kotatsu.ru.grouple
...
internal abstract class GroupleParser(
    ...
    protected open val detailsTagsSelector = "div.creation-element-tags"
    ...
    override suspend fun getDetails(manga: Manga): Manga {
        ...
        return manga.copy(
            ...
            tags = root.selectFirstOrThrow(detailsTagsSelector)
