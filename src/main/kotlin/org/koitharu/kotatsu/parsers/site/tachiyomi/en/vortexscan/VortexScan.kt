package org.koitharu.kotatsu.parsers.site.tachiyomi.en.vortexscan
...
@TachiyomiSource("VORTEXSCANS", "Vortex Scans", "en")
class VortexScans :
    HttpSource(),
    ConfigurableSource {

    private lateinit var summaryOn: String
    private lateinit var summaryOff: String
