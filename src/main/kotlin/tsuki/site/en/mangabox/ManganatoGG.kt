...
@MangaSourceParser("MANGANATOGG", "Manganato.gg", "en")
internal class ManganatoGG(context: MangaLoaderContext) :
    MangaboxParser(context, MangaParserSource.MANGANATOGG) {
    ...
    override suspend fun getChapters(doc: Document): List<MangaChapter> {
        val slug = doc.location()
            ...
            .trim()
        if (slug.isEmpty()) {
            throw ParseException("Cannot extract manga slug", doc.location())
        }
        return fetchChaptersApi(slug)
    }
